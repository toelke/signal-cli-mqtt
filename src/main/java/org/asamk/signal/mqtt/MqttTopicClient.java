...
public class MqttTopicClient implements MqttCallback {
    ...
    private final List<MqttMessageHandler> messageHandlers = new LinkedList<>();
    private static final int QUALITY_OF_SERVICE = 2; // highest quality of service, will be delivered exactly once
